...
unset_vars=(
  ...
  CELERITY_L0_EVENT_POOL_SIZE
  CELERITY_L0_USE_BATCHING
  CELERITY_L0_SMALL_THRESHOLD
  CELERITY_L0_MICRO_THRESHOLD
  CELERITY_L0_BATCH_THRESHOLD_OPS
  CELERITY_L0_BATCH_THRESHOLD_US
)
